...
void indicator_leds_set(
    bool requested_low_led_on,
    bool requested_medium_led_on,
    bool requested_high_led_on
)
{
    low_led_on = requested_low_led_on;
    medium_led_on = requested_medium_led_on;
    high_led_on = requested_high_led_on;
}

void indicator_leds_off(void)
{
    indicator_leds_set(false, false, false);
}
